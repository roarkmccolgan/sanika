			...
			<div class="w-1/2 md:w-1/5 p-2">
				<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					<div class="flipper">
						...
						<div class="back">
							<div class="aspect-fix h-full">
								<a href="/categories/products-services/waterproofing" class="inline-block no-underline text-black mt-2 h-full">
									<div class="flex flex-col h-full text-left leading-tight">
										<h3 class="font-condensed mb-2">Waterproofing Solutions</h3>
										<ul class="list-reset ml-2 flex-1">
											<li class="text-base mb-1">Insulative Boarded Waterproofing</li>
											<li class="text-base mb-1">Concrete Roofing and Decks</li>
											<li class="text-base mb-1">Metal Roof Waterproofing</li>
											<li class="text-base mb-1">Industrial &amp; Mining Anti Corrosive Coatings</li>
										</ul>
			...
			<div class="w-1/2 md:w-1/5 p-2">
				<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					<div class="flipper">
						...
						<div class="back">
							<div class="aspect-fix h-full">
								<a href="categories/products-services/kryton" class="inline-block no-underline text-black mt-2 h-full">
									<div class="flex flex-col h-full text-left leading-tight">
										<h3 class="font-condensed mb-2">Smart Concrete</h3>
										<ul class="list-reset ml-2 flex-1">
											<li class="text-base mb-1">Admixtures &amp; Additives</li>
											<li class="text-base mb-1">Concrete Repair</li>
											<li class="text-base mb-1">Construction Joints &amp; Details</li>
											<li class="text-base mb-1">Surface Applied Waterproofing</li>
										</ul>
										<span class="block my-2 px-3 py-2 bg-sanika-primary text-white rounded shadow">Find out more</span>
									</div>
								</a>
			...
			<div class="w-1/2 md:w-1/5 p-2">
				<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					<div class="flipper">
						...
						<div class="back">
							<div class="aspect-fix h-full">
								<a href="/categories/products-services/emseal" class="inline-block no-underline text-black mt-2 h-full">
									<div class="flex flex-col h-full text-left leading-tight">
										<h3 class="font-condensed mb-2">Expansion Joint Systems</h3>
										<ul class="list-reset ml-2 flex-1">
											<li class="text-base mb-1">Expansion joint covers</li>
											<li class="text-base mb-1">Pre-compressed sealants</li>
											<li class="text-base mb-1">Waterproof</li>
											<li class="text-base mb-1">Rapid installation</li>
											<li class="text-base mb-1">Fire rated</li>
										</ul>
										<span class="block my-2 px-3 py-2 bg-sanika-primary text-white rounded shadow">Find out more</span>
									</div>
								</a>
			...
			<div class="w-1/2 md:w-1/5 p-2">
				<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					<div class="flipper">
						...
						<div class="back">
							<div class="aspect-fix h-full">
								<a href="/categories/products-services/rivestop" class="inline-block no-underline text-black mt-2 h-full">
									<div class="flex flex-col h-full text-left leading-tight">
										<h3 class="font-condensed mb-2">Formwork Systems</h3>
										<ul class="list-reset ml-2 flex-1">
											<li class="text-base mb-1">Hermetically sealed formwork holes</li>
											<li class="text-base mb-1">Removable, reusable, formwork tubes</li>
											<li class="text-base mb-1">Patented Technology</li>
											<li class="text-base mb-1">Specialist Tools</li>
										</ul>
										<span class="block my-2 px-3 py-2 bg-sanika-primary text-white rounded shadow">Find out more</span>
									</div>
								</a>
			...
			<div class="w-1/2 md:w-1/5 p-2">
				<div class="flip-container" ontouchstart="this.classList.toggle('hover');">
					<div class="flipper">
						...
						<div class="back">
							<div class="aspect-fix h-full">
								<a href="/categories/products-services/afrisam" class="inline-block no-underline text-black mt-2 h-full">
									<div class="flex flex-col h-full text-left leading-tight">
										<h3 class="font-condensed mb-2">Afrisam Plaster Pro</h3>
										<ul class="list-reset ml-2 flex-1">
											<li class="text-base mb-1">A single-step, pre-blended plaster solution</li>
											<li class="text-base mb-1">Saves you time and money</li>
											<li class="text-base mb-1">Spectacular finish</li>
											<li class="text-base mb-1">Waterproof barrier</li>
										</ul>
										<span class="block my-2 px-3 py-2 bg-sanika-primary text-white rounded shadow">Find out more</span>
									</div>
								</a>
...
<div class="container flex-1 mx-auto pb-8">
	...
	<div class="flex flex-wrap mt-6">
		...
		<carousel :per-page-custom="[[768, 3], [1024, 6]]" :loop="true" :autoplay-timeout="3000" :pagination-enabled="false" :scroll-per-page="false" :autoplay="true" :autoplay-hover-pause="true" :navigation-enabled="false">
			<slide>
