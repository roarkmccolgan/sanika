	...
	<div class="container mx-auto flex items-center">
		<ais-index :search-store="searchStore" class="flex-grow">
			<div class="container mx-auto flex items-center bg-white px-2 pt-2 sm:px-0">
				<div class="mr-4">
					<a href="/" class="no-underline" title="Homepage"><img width="300" src="/images/sanika_logo.svg" alt=""></a>
				</div>
				<div class="flex items-center w-full">
					<ais-search-box class="w-full relative flex items-center">
						<ais-input placeholder="Search" :class-names="{ 'ais-input': 'shadow appearance-none border rounded flex-grow py-2 px-3 mr-1 text-grey-darker' }">
						</ais-input>
